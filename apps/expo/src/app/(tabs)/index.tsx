...
import type { ActivityWithPartialRoutine } from "~/stores/activityStore";
import type { SunInfo } from "~/stores/sunInfoStore";
...
import fetchSunInfo from "~/stores/sunInfoStore";
      ...
      timeline
        ...
        .forEach((act) => {
          if (act) {
            ...
            void scheduleNotificationForActivity(act);
          }
        });
    };
    void scheduleStuff();
      ...
      <View className="flex flex-row items-center justify-between">
        <View className="flex flex-row items-center gap-2">
          ...
          <Pressable
            ...
            <Text className="text-red-500 absolute right-2 top-3">
              {format(today, "d")}
            </Text>
          </Pressable>
        </View>
...
const Avatar = () => {
  return (
    <Link href="/(modals)/preferences" asChild>
      <Pressable className="bg-stone-400 flex h-14 w-14 items-center justify-center rounded-full">
        <Text>PW</Text>
      </Pressable>
    </Link>
  );
