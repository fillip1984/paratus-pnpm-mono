  ...
  return (
    <View className="flex w-full flex-row rounded">
      ...
      <View className="flex flex-1 justify-center pl-2">
        ...
        <Text className="text-yellow-300/80 mb-2">
          {type === "sunrise"
        ...
        <View className="flex flex-row items-center gap-1">
          ...
          <Text className="text-yellow-300 text-xl">{`${type === "sunrise" ? format(nature.dawn, h_mm_ampm) : format(nature.dusk, h_mm_ampm)}`}</Text>
        </View>
      </View>
    </View>
  );
