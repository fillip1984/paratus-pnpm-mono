...
const LeftActions = (
  ...
  return (
    <>
      <View className="bg-red-600 justify-center">
        <Animated.View
          style={{
          ...
          <Pressable
            onPress={() => {
              void handleCompleteOrSkip(activity, "Skip");
            }}>
            <Text className="font-bold text-white">Skip</Text>
          </Pressable>
        </Animated.View>
      </View>
      <View className="bg-blue-600 justify-center">
        <Animated.View
          style={{
...
const RightActions = (
  ...
  return (
    <View className="bg-green-600 flex-1 items-end justify-center">
      <Animated.Text
        style={{
          color: "white",
